...
# RUN mkdir /opt/meme
# ADD http://meme-suite.org/meme-software/5.1.1/meme-5.1.1.tar.gz /opt/meme
# WORKDIR /opt/meme/
# RUN tar zxvf meme-5.1.1.tar.gz && rm -fv meme-5.1.1.tar.gz
# RUN cd /opt/meme/meme-5.1.1 && \
